...
<Note>
  O token deve ser enviado no formato `Bearer`. Consulte a página [Autenticação API](https://docs.databox360.com.br/api-reference/autenticacao) para verificar o fluxo completo de geração do token.
</Note>
